...
# @testset "NestedUnitRange.jl" begin
    ...
    data = rand(9)
    pbv = BlockArrays.BlockedVector(data, (nur,))
    @test axes(pbv) == (nur,)
    ...
    @test b12 isa BlockArrays.BlockedVector
